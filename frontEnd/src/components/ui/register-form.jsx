  ...
  return (
    <form className={cn("flex flex-col gap-6 sm:mt-12 mt-5", className)} {...props}>
      ...
      <div className="grid gap-6">
        ...
        <Button type="submit" className="w-full bg-gradient-to-r from-emerald-600  to-teal-600  hover:bg-gradient-to-r hover:from-emerald-700 hover:to-teal-700 text-white hover:-translate-y-1" data-aos="fade-up" data-aos-delay="250">
          Create Account
        </Button>
